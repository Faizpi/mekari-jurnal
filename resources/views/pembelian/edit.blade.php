...
<div class="container-fluid">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Permintaan Pembelian #{{ $pembelian->id }}</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('tag') is-invalid @enderror" id="tag" name="tag" value="{{ old('tag', $pembelian->tag) }}" readonly>
                        ...
                        <div class="form-group">
                            ...
                            @else
                                <input type="text" class="form-control" value="{{ $pembelian->gudang->nama_gudang ?? 'Tidak ada gudang' }}" readonly>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            @if($pembelian->lampiran_path)
                                <div class="mb-2">File saat ini: <a href="{{ asset('storage/' . $pembelian->lampiran_path) }}" target="_blank">{{ basename($pembelian->lampiran_path) }}</a></div>
                            @endif
